    ...
    <div class="flex flex-col lg:flex-row pt-8 w-full mt-10 max-w-[1490px]">
      <div class="flex flex-col">
        ...
        <div class="w-full p-4 h-full">
          <p
            class="text-xl balanced leading-10 xl:text-2xl xl:leading-relaxed 2xl:leading-loose w-full"
          >
            a Junior Web Developer with a keen interest in creating projects that support social and
            environmental causes. Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci
            in explicabo nisi!
          </p>
        </div>
      </div>
